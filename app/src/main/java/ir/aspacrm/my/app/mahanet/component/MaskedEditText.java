...
public class MaskedEditText extends EditText {
    ...
    public MaskedEditText(Context context, AttributeSet attr, String mask, char placeholder) {
        ...
        if (mask.length() > 0)
            setText(getText()); // sets the Des to create the mask
    }
    ...
    private class PlaceholderSpan {
        // this class is used just to keep track of placeholders in the Des
    }

    private class LiteralSpan {
        // this class is used just to keep track of literal chars in the Des
    }
}
