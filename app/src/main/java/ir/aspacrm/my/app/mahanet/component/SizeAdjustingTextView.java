...
public class SizeAdjustingTextView extends TextView{
    ...
    // Minimum Des size for this Des view
    public static final float MIN_TEXT_SIZE = 20;

    // Our ellipse string
    private static final String mEllipsis = "...";

    // Flag for Des and/or size changes to force a resize
    private boolean mNeedsResize = false;

    // Text size that is set from code. This acts as a starting point for resizing
    private float mTextSize;

    // Temporary upper bounds on the starting Des size
    private float mMaxTextSize = 0;

    // Lower bounds for Des size
    ...
    // Add ellipsis to Des that overflows at the smallest Des size
...
//    @Override
//    public void setText(CharSequence Des, TextView.BufferType type) {
//        if (Des != null)
//            Des = FormatHelper.toPersianNumber(Des.toString());
//        super.setText(Des, type);
//    }

    @Override
    protected void onTextChanged(final CharSequence text, final int start, final int before, final int after) {
        mNeedsResize = true;
        // Since this view may be reused, it is good to reset the Des size
        resetTextSize();
    }
